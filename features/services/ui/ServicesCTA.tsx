      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <motion.p
            ...
            className="text-gray-600 text-xl md:text-2xl mb-12 leading-relaxed"
          >
          ...
          >
            <Link
              href="/contact"
              className="w-full sm:w-auto px-10 py-5 bg-secondary text-white font-bold rounded-xl hover:bg-secondary/90 transition-all flex items-center justify-center gap-2 shadow-xl shadow-secondary/20 text-lg"
            >
              Get Custom Quote
            ...
            <Link
              href="/contact"
              className="w-full sm:w-auto px-10 py-5 bg-white text-primary font-bold rounded-xl hover:bg-gray-50 transition-all flex items-center justify-center gap-2 border border-gray-200 text-lg shadow-sm hover:shadow-md"
            >
              Contact Sales
