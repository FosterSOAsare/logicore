...
export default function TrackingDetails({
  ...
  return (
    <div className="max-w-6xl bg-white rounded-xl mx-auto px-6 lg:px-8 py-8">
      <div className="space-y-8">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          ...
          <div className="flex gap-3">
            <Link
              href="/contact"
              className="px-4 py-2 bg-secondary text-white rounded-xl font-medium hover:bg-secondary/90 transition-colors shadow-lg shadow-secondary/20"
            >
              Contact Support
            </Link>
          </div>
            ...
            <div className="flex-1">
              <div className="flex justify-between items-end mb-6">
                <div>
                  ...
                  <p className="text-gray-500 text-sm">Dec 08, 2025</p>
                </div>
                <div className="text-right">
                  ...
                  <p className="text-gray-500 text-sm">Est. Dec 12, 2025</p>
                </div>
              </div>
                ...
                <div className="relative flex justify-between">
                  {progressSteps.map((step, i) => {
                    ...
                    return (
                      ...
                      >
                        <div
                          className={`w-10 h-10 rounded-full border-[3px] z-10 flex items-center justify-center transition-all duration-500 ${
                        ...
                        <span
                          className={`text-xs font-bold uppercase tracking-wider transition-colors duration-500 text-center ${
                            isCompleted || isCurrent
                              ? "text-primary"
                              : "text-gray-400"
                          }`}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <motion.div
            ...
            className="lg:col-span-2 bg-white rounded-2xl p-8 shadow-xl shadow-gray-200/50 border border-gray-100"
          >
            ...
            <div className="relative space-y-8 before:absolute before:left-[19px] before:top-2 before:h-[calc(100%-24px)] before:w-0.5 before:bg-gray-100">
              {shipmentData.timeline.map((event, index) => (
                <div key={index} className="relative pl-12 group">
                  <div
                    className={`absolute left-0 top-1 w-10 h-10 rounded-full border-4 border-white flex items-center justify-center z-10 transition-colors ${
                      event.completed
                    ...
                    <div>
                      <h4
                        className={`font-bold text-base ${
                          event.completed ? "text-primary" : "text-gray-600"
                        }`}
                      >
                        {event.status}
                      </h4>
        ...
        <div className="bg-blue-50 rounded-2xl w-full p-6 border border-blue-100">
